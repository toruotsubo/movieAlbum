...
export const TRANSLATIONS = {
  ja: {
    ...
    confirmResetData: '設定とすべての登録データを初期化しますか？この操作は取り消せません。',
    confirmDeleteDb: '現在選択中の設定ファイル「{name}」を削除しますか？この操作は取り消せません。',
    resetData: 'データ初期化',
    on: 'ON',
    off: 'OFF',
    ...
    // Settings Modal
    settings_title: '設定',
    settings_db_name: '設定ファイル名',
    settings_db_select: '設定ファイル選択',
    settings_add_db: '設定ファイル追加',
    settings_delete_db: '設定ファイル削除',
    settings_section1: 'ユーザー定義項目（最大3つまで）',
    settings_section2: 'メイン項目の選択と項目の並び替え',
    settings_section2_desc: 'メインインデックスで使用する項目を1つ選択してください。「タイトル」「評価」以外はドラッグして表示順を変更できます。',
    settings_section3: '言語設定',
    ...
    form_close_player: 'プレビューに戻る',
    form_capturing: 'キャプチャ中...',
    form_capture_btn: '現在のフレームを保存',
    ...
    form_release_year_label: '公開年 (公開年月日)',
    form_release_year_placeholder: '例: 2025,20250915',
    form_release_date_label: '公開月日',
    form_release_date_placeholder: '例: 09-15,0915',
  ...
  en: {
    ...
    confirmDeleteDb: 'Are you sure you want to delete settings file "{name}"? This operation cannot be undone.',
    ...
    settings_db_name: 'Settings File Name',
    settings_db_select: 'Select Settings File',
    settings_add_db: 'Add Settings File',
    settings_delete_db: 'Delete Settings File',
    settings_section1: 'User defined items (max 3)',
    settings_section2: 'Select key item and sort items',
    ...
    form_close_player: 'Back to Preview',
    form_capturing: 'Capturing...',
    form_capture_btn: 'Capture Frame',
    form_rewind_5s: '-5s',
    form_forward_5s: '+5s',
    ...
    form_release_year_label: 'Release Year (YYYY,YYYYMMDD)',
    form_release_year_placeholder: 'e.g., 2025,20250915',
    form_release_date_label: 'Release Date (MM-DD,MMDD)',
    form_release_date_placeholder: 'e.g., 09-15,0915',
